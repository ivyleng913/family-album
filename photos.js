const photos = [
  ...
  {
    image: ["images/photo29.png", "images/photo30.png", "images/photo31.png", "images/photo41.png"],
    date: "2023/8/16",
    location: "英国剑桥",
  ...
  {
    image: ["images/photo10.png", "images/photo20.png"],
    date: "2025/7/13",
    location: "四川九鼎山",
    text: "这个地方我印象太深，美得像户外广告"
  },
  {
    image: ["images/photo4.png", "images/photo19.png", "images/photo21.png", "images/photo22.png"],
    date: "2025/8/7",
    location: "四川雅安蒙顶山",
    text: "景色太好了 看起来玩的很开心"
  },
  ...
  {
    image: ["images/photo3.png", "images/photo5.png", "images/photo16.png"],
    date: "2026/2/16",
    location: "四川绵阳",
    text: "回家过年！我本命年哈哈哈"
  },
  {
    image: ["images/photo8.png", "images/photo18.png"],
    date: "2026/2/23",
    location: "四川自贡",
    text: "看完发现欣赏不来灯会 但挺开心！"
  },
  {
    image: ["images/photo15.png", "images/photo40.png"],
    date: "2026/2/24",
    location: "四川乐山",
    text: "乐山确实好吃，下次还吃"
  },
  ...
  {
    image: ["images/photo24.png", "images/photo25.png"],
    date: "2026/5/2",
    location: "虎牙",
    text: "五月还有这么大的雪"
  },
  ...
  gallery.innerHTML = photos
    ...
    <div class="photo-card${i % 2 === 1 ? " reverse" : ""}">
      <div class="photo-images">
        ${(Array.isArray(photo.image) ? photo.image : [photo.image])
          .map((image) => `<img src="${image}" alt="${photo.location || '照片'}" />`)
          .join("")}
      </div>
      <div class="photo-text">
        ${photo.date ? `<p class="date">${photo.date}${photo.location ? ` · ${photo.location}` : ""}</p>` : ""}
